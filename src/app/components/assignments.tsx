...
function Assignments() {
  return (
    <div>
      <h1 className="font-black text-center text-5xl text-white mt-5">ASSIGNMENTS</h1>
...
<a href="https://vercel.com/muhammad-bilal-hussains-projects" target="_blank">
    <div className="relative w-[410px] h-[300px] rounded-[10px] flex items-center justify-center overflow-hidden transition-all duration-600 ease-[cubic-bezier(0.23, 1, 0.32, 1)] hover:scale-110 hover:shadow-[0_10px_20px_rgba(255,255,255,0.5)]">
      <Image
        ...
        objectFit="cover"
      />
      <div className="absolute inset-0 flex flex-col items-center justify-center bg-red-700 opacity-0 transition-all duration-600 ease-in-out hover:opacity-90">
        <h3 className="text-[24px] text-white font-bold text-center">
        Hackathom Milestones Resume Builder (HTML, CSS, TypeScript)
          
        </h3>
        <p className="mt-[10px] text-[14px] text-white leading-[1.4] text-center p-5">
  ...
  <a
    href="https://github.com/Muhammad-Bilal-Hussain/simple-calculator-assignment"
    target="_blank">
    <div className="relative w-[410px] h-[300px] rounded-[10px] flex items-center justify-center overflow-hidden transition-all duration-600 ease-[cubic-bezier(0.23, 1, 0.32, 1)] hover:scale-110 hover:shadow-[0_10px_20px_rgba(255,255,255,0.5)]">
      <Image
        src="/image/simple-calculator.jpg"
        alt=""
        layout="fill"
        objectFit="cover"
      />
  ...
  <a href="https://github.com/Muhammad-Bilal-Hussain/Number_Guessing_Game" target="_blank">
    <div className="relative w-[410px] h-[300px] rounded-[10px] flex items-center justify-center overflow-hidden transition-all duration-600 ease-[cubic-bezier(0.23, 1, 0.32, 1)] hover:scale-110 hover:shadow-[0_10px_20px_rgba(255,255,255,0.5)]">
      <Image
  ...
  <a href="https://github.com/Muhammad-Bilal-Hussain/Word-counter" target="_blank">
    <div className="relative w-[410px] h-[300px] rounded-[10px] flex items-center justify-center overflow-hidden transition-all duration-600 ease-[cubic-bezier(0.23, 1, 0.32, 1)] hover:scale-110 hover:shadow-[0_10px_20px_rgba(255,255,255,0.5)]">
      <Image
  ...
  <a href="https://github.com/Muhammad-Bilal-Hussain/-BilalATM" target="_blank">
    <div className="relative w-[410px] h-[300px] rounded-[10px] flex items-center justify-center overflow-hidden transition-all duration-600 ease-[cubic-bezier(0.23, 1, 0.32, 1)] hover:scale-110 hover:shadow-[0_10px_20px_rgba(255,255,255,0.5)]">
      <Image
        src="/image/ATM.jpg"
        alt=""
  ...
  <a href="https://github.com/Muhammad-Bilal-Hussain/TodoList" target="_blank">
    <div className="relative w-[410px] h-[300px] rounded-[10px] flex items-center justify-center overflow-hidden transition-all duration-600 ease-[cubic-bezier(0.23, 1, 0.32, 1)] hover:scale-110 hover:shadow-[0_10px_20px_rgba(255,255,255,0.5)]">
      <Image
        src="/image/todo.png"
        alt=""
  ...
  <a href="https://github.com/Muhammad-Bilal-Hussain/Currency-Convertor" target="_blank">
    <div className="relative w-[410px] h-[300px] rounded-[10px] flex items-center justify-center overflow-hidden transition-all duration-600 ease-[cubic-bezier(0.23, 1, 0.32, 1)] hover:scale-110 hover:shadow-[0_10px_20px_rgba(255,255,255,0.5)]">
      <Image
  ...
  <a href="https://github.com/Muhammad-Bilal-Hussain/Std_Management_System" target="_blank">
    <div className="relative w-[410px] h-[300px] rounded-[10px] flex items-center justify-center overflow-hidden transition-all duration-600 ease-[cubic-bezier(0.23, 1, 0.32, 1)] hover:scale-110 hover:shadow-[0_10px_20px_rgba(255,255,255,0.5)]">
      <Image
        src="/image/SMS.jpg"
        alt=""
  ...
  <a
    href="https://github.com/Muhammad-Bilal-Hussain/project00"
    target="_blank"
